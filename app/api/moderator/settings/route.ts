// app/api/moderator/settings/route.ts
...
const kvKey = (uid: string) => `moderator_settings:${uid}`
const INIT = `CREATE TABLE IF NOT EXISTS kv_store (key TEXT PRIMARY KEY, value TEXT NOT NULL, updated_at TEXT)`
