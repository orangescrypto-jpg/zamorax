...
// Seller settings: store preferences, payout config, notifications, security, danger zone.
...
export default function SellerSettingsPage() {
  ...
  useEffect(() => {
    if (!user?.uid) return
    AdminService.getDoc("sellerSettings", user.uid).then(docs => {
