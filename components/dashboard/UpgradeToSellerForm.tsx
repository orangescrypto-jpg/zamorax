        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <div className="text-sm text-green-800">
              ...
              <p className="text-xs mt-0.5">{s.planFreeListingLimit ?? 5} active listings · NIN-verified badge · You can upgrade to Pro anytime.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="p-4 flex items-start gap-3">
          ...
          <div className="text-sm">
            <p className={`font-semibold ${plan === "pro" ? "text-amber-900" : "text-primary"}`}>
              {plan === "pro" ? `Pro Plan — ${fmt(s.planProPrice)}/mo` : `Starter Plan — ${fmt(s.planStarterPrice)}/mo`}
            </p>
            <p className="text-xs text-muted-foreground mt-0.5">
              {plan === "pro"
                ? `${s.planProListingLimit === 0 ? "Unlimited" : s.planProListingLimit} listings · Gold badge · Priority WhatsApp support`
                : `${s.planStarterListingLimit} listings · Verified badge · Analytics dashboard`}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border">
        <CardContent className="p-4 space-y-2">
          ...
          {(plan === "pro"
            ...
            : ["Verified badge on all listings", `${s.planStarterListingLimit} active listings`, "Analytics dashboard", "Standard support"]
          ).map((b) => (
