...
// Maps every Firebase auth error code to a clean, user-friendly message.
// Before: users saw "Firebase: Error (auth/invalid-credential)." raw in the toast.
// Now: they see "Incorrect email or password. Please try again."
...
export function LoginForm() {
  ...
  const handleResendVerification = async () => {
    if (!unverifiedUser || !unverifiedPassword) return
    ...
    try {
      ...
      toast({ title: "Failed to resend. Try again in a minute.", variant: "destructive" })
