...
// Shown before Firestore loads or if admin has no banners yet
const FALLBACK: Banner[] = [
  { id: "f1", tag: "HOT DEALS",    title: "Phones & Tablets",    subtitle: "Verified phones at great prices",  href: "/categories/phones-tablets", color: "dark",   icon: "zap",      order: 0 },
  { id: "f2", tag: "ESCROW SAFE",  title: "Laptops & Computing", subtitle: "Buy with full buyer protection",   href: "/categories/computing",       color: "orange", icon: "shield",   order: 1 },
  { id: "f3", tag: "TRENDING NOW", title: "Fashion & Clothing",  subtitle: "New arrivals every day",           href: "/categories/fashion",          color: "teal",   icon: "trending", order: 2 },
]
